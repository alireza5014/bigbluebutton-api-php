 ...
 * Alireza5014 open source conferencing system - https://www.Alireza5014.org/.
 *
 * Copyright (c) 2016-2018 Alireza5014 Inc. and by respective authors (see below).
 *
 * This program is free software; you can redistribute it and/or modify it under the
 * terms of the GNU Lesser General Public License as published by the Free Software
 * Foundation; either version 3.0 of the License, or (at your option) any later
...
class GetMeetingInfoResponseTest extends \Alireza5014\TestCase
{
    ...
    public function testGetMeetingInfoMetadataContent()
    {
        ...
        $this->assertEquals('Alireza5014 "Mock meeting for testing getMeetingInfo"', $metas['bbb-recording-name']);
    }
}
